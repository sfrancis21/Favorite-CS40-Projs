/* 
 * a2plain.c
 * This file was completed by: Juliana Rosen (jrosen33) and 
                               Sara Francis (sfranc07), 10/3/22
 * HW3: locality
 * 
 * Summary: implementation of the a2plain interface that can be used 
 *          for any mapping function. 
 */
...
static struct A2Methods_T uarray2_methods_plain_struct = {
        ...
        map_row_major,                  
        map_col_major,                  
        NULL,                                   // map_block_major func
        map_row_major,                          // map_block_major default func
        small_map_row_major,            
        small_map_col_major,            
